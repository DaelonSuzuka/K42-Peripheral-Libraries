...
// K42 output values
#define PPS_ADGRDB b110010
#define PPS_ADGRDA b110001
#define PPS_CWG3D b110000
#define PPS_CWG3C b101111
#define PPS_CWG3B b101110
#define PPS_CWG3A b101101
#define PPS_CWG2D b101100
#define PPS_CWG2C b101011
#define PPS_CWG2B b101010
#define PPS_CWG2A b101001
#define PPS_DSM1 b101000
#define PPS_CLKR b100111
#define PPS_NCO1 b100110
#define PPS_TMR0 b100101
#define PPS_I2C2_SDA b100100
#define PPS_I2C2_SCL b100011
#define PPS_I2C1_SDA b100010
#define PPS_I2C1_SCL b100001
#define PPS_SPI1_SS b100000
#define PPS_SPI1_SDO b011111
#define PPS_SPI1_SCK b011110
#define PPS_C2OUT b011101
#define PPS_C1OUT b011100
#define PPS_UART2_RTS b011000
#define PPS_UART2_TXDE b010111
#define PPS_UART2_TX b010110
#define PPS_UART1_RTS b010101
#define PPS_UART1_TXDE b010100
#define PPS_UART1_TX b010011
#define PPS_PWM8 b010000
#define PPS_PWM7 b001111
#define PPS_PWM6 b001110
#define PPS_PWM5 b001101
#define PPS_CCP4 b001100
#define PPS_CCP3 b001100
#define PPS_CCP2 b001010
#define PPS_CCP1 b001001
#define PPS_CWG1D b001000
#define PPS_CWG1C b000111
#define PPS_CWG1B b000110
#define PPS_CWG1A b000101
#define PPS_CLC4OUT b000100
#define PPS_CLC3OUT b000011
#define PPS_CLC2OUT b000010
#define PPS_CLC1OUT b000001
#define PPS_LATxy b000000

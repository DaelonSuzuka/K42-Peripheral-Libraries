...
//
void smt_start(void) { SMT1CON1bits.SMT1GO = 1; }
void smt_stop(void) { SMT1CON1bits.SMT1GO = 0; }
...
//
void smt_interrupt_enable(void) { SMT1IE = 1; }
void smt_interrupt_disable(void) { SMT1IE = 0; }
void smt_clear_interrupt_flag(void) { SMT1IF = 0; }

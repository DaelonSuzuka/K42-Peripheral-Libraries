...
//! not yet
#elif FAMILY_Q41
    NCO_CLOCK_SOURCE_CLC4_OUT = 0b1101,
    NCO_CLOCK_SOURCE_CLC3_out = 0b1100,
    NCO_CLOCK_SOURCE_CLC2_OUT = 0b1011,
    NCO_CLOCK_SOURCE_CLC1_OUT = 0b1010,
    NCO_CLOCK_SOURCE_TMR4_OUT = 0b1001,
    NCO_CLOCK_SOURCE_TMR2_OUT = 0b1000,
    NCO_CLOCK_SOURCE_CLKREF = 0b0111,
    NCO_CLOCK_SOURCE_EXTOSC = 0b0110,
    NCO_CLOCK_SOURCE_SOSC = 0b0101,
    NCO_CLOCK_SOURCE_MFINTOSC_32 = 0b0100,
    NCO_CLOCK_SOURCE_MFINTOSC_500 = 0b0011,
    NCO_CLOCK_SOURCE_LFINTOSC = 0b0010,
